...
tactics: [Credential Acquisition, Infrastructure Acquisition, Tool Development, Specific Target Scraping, Loose Target Scraping, CAPTCHA Bypass, Human Emulation, Proxying, Data Extraction, Sale]
techniques: [Valid Accounts, Botnet, Proxies, Development of Tools, Testing of Tools, Campaign Reuse, Continual Content Scraping, Periodic Content Scraping, CAPTCHA Farm, Automated CAPTCHA Bypass, User Agent Spoofing, IP Rotation, Automated Add to Cart, Inventory Hoarding, Transfer of Cart, Automated Purchase, Inventory Information Release, Automated Sale]
